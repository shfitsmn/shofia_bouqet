      ...
      <div class="row justify-content-between align-items-center w-100">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">Buket Uang </a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">Buket Bunga </a>
                    </li>
                    <li>
                      <a href="index.html" class="dropdown-item item-anchor">Buket Snack </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            ...
            <li class="d-none d-lg-block">
              <a href="/login" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                aria-controls="offcanvasCart">Login 
              </a>
            </li>
            @endauth
